...
hook](https://github.com/nholuongut/pre-commit-hooks).
...
```shell
helm plugin install https://github.com/nholuongut/kubeconform-helm
```
...
[plugin](https://github.com/nholuongut/kubeconform-helm/blob/main/scripts/plugin_wrapper.py)
is as follows:
...
```yaml
repos:
  - repo: https://github.com/nholuongut/kubeconform-helm
    rev: v0.1.17
    hooks:
      - id: kubeconform-helm
```
...
The full list of options for the
[hook](https://github.com/nholuongut/kubeconform-helm/blob/main/scripts/pre-commit.py)
is as follows:
...
This repo utilises [`pre-commit`](https://github.com/nholuongut/pre-commit-hooks) hooks to lint code
...
can be found [here](https://github.com/nholuongut/pre-commit-hooks#installation).
